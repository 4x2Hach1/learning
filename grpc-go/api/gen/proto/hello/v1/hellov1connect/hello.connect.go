...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/4x2Hach1/learning/grpc-go/api/gen/proto/hello/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceName = "proto.hello.v1.HelloService"
)
...
const (
	...
	HelloServiceHelloProcedure = "/proto.hello.v1.HelloService/Hello"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	helloServiceServiceDescriptor     = v1.File_proto_hello_v1_hello_proto.Services().ByName("HelloService")
	helloServiceHelloMethodDescriptor = helloServiceServiceDescriptor.Methods().ByName("Hello")
)

// HelloServiceClient is a client for the proto.hello.v1.HelloService service.
type HelloServiceClient interface {
	Hello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloResponse], error)
}

// NewHelloServiceClient constructs a client for the proto.hello.v1.HelloService service. By
...
// Hello calls proto.hello.v1.HelloService.Hello.
...
// HelloServiceHandler is an implementation of the proto.hello.v1.HelloService service.
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.hello.v1.HelloService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHelloServiceHandler) Hello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.hello.v1.HelloService.Hello is not implemented"))
}
